			...
			Model consists of two layers: services and persistance. 
				...
				Persistance.
					...
					It has three packages: Entity, JpaRepository, Dao.
						Entity. 
							These dto classes are mapped to database tables. 
							There are four main objects: person, product, 
							order, cartitem.
							Cartitem - is a class, containig product id and its
							amount in user's cart.
						JpaRepository.
							Extended Spring's interfaces JpaRepository.
							They already have crud operations realised. 
						Dao.
							Provides interaction between Services layer 
							and JpaRepository.
		Controller. 
